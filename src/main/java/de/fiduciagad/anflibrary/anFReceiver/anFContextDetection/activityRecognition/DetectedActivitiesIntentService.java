    ...
    protected void onHandleIntent(Intent intent) {
        ...
        for (DetectedActivity da : detectedActivities) {
            if (detectedActivity == null) {
                ...
                if (da.getConfidence() > detectedActivity.getConfidence()) {
                    detectedActivity = da;
                }
            }
            String detectedActivityString = "Detected " + Constants.getName(da.getType()) + " " + da.getConfidence() + " %";
            Log.i(TAG, detectedActivityString);
        }

        // Broadcast most Propable detected Activity
